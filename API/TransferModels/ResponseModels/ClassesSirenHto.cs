...
namespace API.TransferModels.ResponseModels
{
    public class ClassesSirenHto : SirenHto
    {
        ...
        public Entity Collection(PagedList<Class> items, ListQueryStringDto query)
        {
            var entity = new EntityBuilder()
                    .WithClass("class")
        ...
        public Entity ClassGroupsCollection(PagedList<Group> groups, ListQueryStringDto query)
        {
            var entity = new EntityBuilder()
                    .WithClass("group")
                    .WithClass("collection")
